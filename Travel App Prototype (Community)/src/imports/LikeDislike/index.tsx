import svgPaths from "./svg-lbogm8g429";
...
export default function LikeDislike() {
  return (
    <div className="content-stretch flex gap-[12.741px] items-center justify-center relative size-full" data-name="Like dislike">
      <ActionBtn />
      <ActionBtn1 />
    </div>
  );
